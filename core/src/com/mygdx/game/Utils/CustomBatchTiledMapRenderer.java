...
public abstract class CustomBatchTiledMapRenderer implements TiledMapRenderer, Disposable {
    static protected final int NUM_VERTICES = 20;

    protected TiledMap map;

    protected float unitScaleWidth;
    protected float unitScaleHeight;
    ...
    public CustomBatchTiledMapRenderer (TiledMap map, float unitScaleWidth, float unitScaleHeight) {
        this.map = map;
        this.unitScaleWidth = unitScaleWidth;
        this.unitScaleHeight = unitScaleHeight;
        this.viewBounds = new Rectangle();
        this.batch = new SpriteBatch();
        this.ownsBatch = true;
    }

    public CustomBatchTiledMapRenderer (TiledMap map, float unitScaleWidth, float unitScaleHeight,  Batch batch) {
        this.map = map;
        this.unitScaleWidth = unitScaleWidth;
        this.unitScaleHeight = unitScaleHeight;
        this.viewBounds = new Rectangle();
    ...
    public void renderImageLayer (TiledMapImageLayer layer) {
        ...
        final float x1 = x * unitScaleWidth;
        final float y1 = y * unitScaleHeight;
        final float x2 = x1 + region.getRegionWidth() * unitScaleWidth;
        final float y2 = y1 + region.getRegionHeight() * unitScaleHeight;
